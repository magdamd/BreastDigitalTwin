...
The phantoms are defined with the BIfTI format [1].
...
**Sequences**
 ...
 The sequences are written in the Pulseq .seq format [2]. The supplied sequences are FLASH and TSE sequences with various contrasts:
...
Phantom and sequences can be tested using the Any-Field scanner [3]. Some pre-loaded sequences can be found under these links:
...
* Sequences with off-resonant RF pulses (sequences with FatSat) will not create the expected effect, because the Any-Field scanner currently does not support the extension of MR-zero to off-resonant behavior. Having that into account, no links with that same experiences are provided. 
...
* Simulation of the links provided is expected to take approximately 5 minutes due to the high resolution of the sequences (512x512).
...
[1] J. Endres, mrx-org/bifti-phantoms. (May 27, 2026). Python. MRX. Accessed: Jun. 01, 2026. [Online]. Available: https://github.com/mrx-org/bifti-phantoms

[2] K. J. Layton et al., ‘Pulseq: A rapid and hardware-independent pulse sequence prototyping framework’, Magnetic Resonance in Medicine, vol. 77, no. 4, pp. 1544–1552, 2017, doi: 10.1002/mrm.26235.

[3] S. Weinmüller et al., ‘Any-Field Scanner: A Virtual MRI Scanner for Rapid and Realistic Pulseq Sequence Validation in the Browser’, presented at the Acceepted at ESMRMB Annual Congress 2026,
