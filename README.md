...
- 3T ideal phantom and TSE in-phase sequence (Figure 3B.1): 
- 3T ideal phantom and TSE STIR sequence (Figure 3C.1):
- 3T inhomogeneous B1+ phantom and TSE STIR sequence (Figure 5C.1):
